...
# =====================================================================
# THAM SỐ KINH TẾ (QUAN TRỌNG)
# =====================================================================

# --- Tham số Bài toán Hợp đồng & Game Theory ---
TOTAL_SAT_RESOURCE_B_HZ = 100e6

# "Hiệu quả" (theta) của các agent được đặt ở mức cao để đảm bảo có lợi nhuận
AGENT_TYPES = {
    'low_efficiency': {
        'theta': 5.0,  # Giá trị theta cho agent loại "thấp"
        'prob': 0.5    # Xác suất xuất hiện của agent loại "thấp"
    },
    'high_efficiency': {
        'theta': 10.0, # Giá trị theta cho agent loại "cao"
        'prob': 0.5    # Xác suất xuất hiện của agent loại "cao"
    }
}

# Chi phí hoạt động của Vệ tinh được đặt ở mức thấp để khuyến khích phân bổ
# cost = c1 * R + c2 * R^2
SAT_COST_C1 = 0.001
SAT_COST_C2 = 0.0005
